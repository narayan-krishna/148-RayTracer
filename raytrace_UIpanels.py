...
# Custom Properties for SimpleRT lights
...
class SimpleRTLightPanel(bpy.types.Panel):
    ...
    def poll(cls, context):
        return (
            context.scene.render.engine == "simple_RT"
            and context.object.type == "LIGHT"
        )

    def draw(self, context):
        lt = context.light.simpleRT_light
...
def register():
    ...
    bpy.types.PointLight.simpleRT_light = bpy.props.PointerProperty(type=LightSettings)
